...
from app.core.security import CurrentUser, require_role, ROLE_HIERARCHY, VALID_ROLES
...
class TestEditorRouteAccess:
    ...
    def test_editor_can_create_estimate(self):
...
class TestAdminRouteAccess:
    ...
    def test_admin_can_change_user_role(self):
        ...
        with patch("app.api.v1.admin.firebase_auth.set_custom_user_claims") as mock_claims:
            try:
                resp = client.patch(
